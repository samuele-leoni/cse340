...
ALTER TYPE public.account_type OWNER TO cse340sl;
...
CREATE TABLE IF NOT EXISTS public.review (
  ...
  review_creation date NOT NULL,
  review_modified date,
  inv_id integer NOT NULL,
  account_id integer,
  CONSTRAINT review_pkey PRIMARY KEY (review_id),
  CONSTRAINT review_account_fk FOREIGN KEY (account_id) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION,
  CONSTRAINT review_inv_fk FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION
);